-- First delete seats, then trains to avoid foreign key constraint issues
DELETE FROM seats;
DELETE FROM trains;
...
('12723', 'Telangana Express', 
 ...
 '{"2A": 4650, "3A": 3150, "SL": 2150, "2S": 810}', 
...
('12137', 'Punjab Mail', 
 ...
 '{"2A": 3200, "3A": 2100, "SL": 1850, "2S": 585}', 
 ARRAY['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'], 82),
...
('12841', 'Coromandel Express', 
 ...
 '{"2A": 4200, "3A": 2850, "SL": 1980, "2S": 720}', 
...
-- Additional inter-state connections
